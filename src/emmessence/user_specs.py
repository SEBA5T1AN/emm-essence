...
allDataObjects = {
    ...
    "STO": STORAGES_DATA,
    "D": DEMANDS_DATA,
    "C_P_AVA": CONVERTER_AVA_PROFILES_DATA,
    "STO_P_MAX_LEVEL": STORAGE_MAX_LEVEL_PROFILES_DATA,
    "STO_P_MIN_LEVEL": STORAGE_MIN_LEVEL_PROFILES_DATA,
    "STO_P_NAT_INFLOW": STORAGE_NAT_INFLOW_PROFILES_DATA,
    "D_P": DEMAND_PROFILES_DATA,

    "N": NODES_DATA,
    "C_T": CONVERTER_TYPES_DATA,
    "STO_T": STORAGE_TYPES_DATA,
    "D_T": DEMAND_TYPES_DATA,
    "L": LINES_DATA,
    "M": MEDIA_DATA,
    "Z": ZONES_DATA,
    "TR": TRADE_LIMITS_DATA,
    "IA": IMPORT_ACCESSES_DATA,
    "EA": EXPORT_ACCESSES_DATA,
}